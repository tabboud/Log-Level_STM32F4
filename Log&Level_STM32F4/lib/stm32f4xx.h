 ...
 * @brief Comment the line below if you will not use the peripherals drivers.
   ...
   */
    //#define USE_STDPERIPH_DRIVER		//Add the periph libraries, comment out whats not needed in stm32f4xx_conf.h
 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */           
  ...
  #define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in 8MHz */
#endif /* HSE_VALUE */
...
#include "core/core_cm4.h"             /* Cortex-M4 processor and core peripherals */
...
/**
  ...
  */
  ...
  /**
  * @}///Assert_failed found in stm32f4xx_conf.h
  */
